...
///     the presentation - bed channels and objects together - and is absent when the
///     stream declares no such total.
///     <p><hr>
...
const infomap player_process[] = {{"videodecoder", PLAYER_PROCESS_VIDEODECODER},
                                  ...
                                  {"audio.object.layout", PLAYER_PROCESS_AUDIO_OBJECT_LAYOUT},
                                  ...
                                  {"video.dovi.l5.auto", PLAYER_PROCESS_VIDEO_DOVI_L5_AUTO },
...
const infomap listitem_labels[]= {{ "thumb",            LISTITEM_THUMB },
                                  ...
                                  { "hdrtypealt",       LISTITEM_VIDEO_HDR_TYPE_ALT },
                                  { "dvprofile",        LISTITEM_VIDEO_DV_PROFILE },
