...
public:
  ...
  static constexpr auto SETTING_VIDEOPLAYER_MKV_EDITIONS_ENABLED = "videoplayer.mkv_editions_enabled";
  ...
  static constexpr auto SETTING_COREELEC_AMLOGIC_DV_VS10_SDR_PER_FRAME_METADATA = "coreelec.amlogic.dolbyvision.vs10.sdr.per.frame.metadata";
  static constexpr auto SETTING_COREELEC_AMLOGIC_DV_VS10_TARGET_MIN_LUM = "coreelec.amlogic.dolbyvision.vs10.target.min.lum";
  ...
  static constexpr auto SETTING_COREELEC_AMLOGIC_DV_LEVEL5_OVERRIDE = "coreelec.amlogic.dolbyvision.level5.override";
  ...
  static constexpr auto SETTING_COREELEC_AMLOGIC_VIDEO_RESTART_MUTE_DV_ONLY = "coreelec.amlogic.video.restart.mute.dvonly";
